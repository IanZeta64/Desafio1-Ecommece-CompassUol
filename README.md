...
The project aimed to experiment and apply the main concepts of OOP, such as inheritance, polymorphism, encapsulation, and abstraction, in addition to utilizing Java features like Stream and Enum.
